...
<div class="row-sm align-items-center">
	...
	<div class="col-lg-10-24 col-sm-8 small text-light">
		 <a class="text-light text-margin" href="addAddress.jsp">My Address</a> <a  class="text-light text-margin" href="customer_orders.jsp" id="myAmazon">My Orders</a> <a  class="text-light text-margin"  href="card_details.jsp">My Cards</a> <a class="text-light text-margin" href="addprd.jsp">Sell</a> <a class="text-light text-margin" href="manage_sales.jsp">Customer Service</a> 	</div> <!-- col.// -->
