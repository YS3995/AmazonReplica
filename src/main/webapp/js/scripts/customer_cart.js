   ...
   var udata = JSON.parse(localStorage.getItem("userdata"));
	...
	//    data = JSON.parse(data);
		...
		data.forEach(function(cartitem){
			...
			totalvat=totalvat+ (discountedprice * qty*0.05);
			...
			var Template = "";    
					    ...
					    Template = Template + "</div></td><td><div class='price-wrap'><var class='price'>"+discountedprice * qty*0.05+"</var></div>";
		...
		document.getElementById('totalvat').innerHTML=totalvat;
		//$('#totalvat');
	});
